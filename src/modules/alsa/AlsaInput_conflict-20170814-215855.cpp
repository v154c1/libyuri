...
#include "../alsa/AlsaInput.h"

#include "yuri/core/Module.h"
#include "yuri/core/frame/raw_audio_frame_types.h"
namespace yuri {
namespace alsa_input {


IOTHREAD_GENERATOR(AlsaInput)

MODULE_REGISTRATION_BEGIN("alsa_input")
...
std::map<format_t, snd_pcm_format_t> alsa_to_yuri_formats = {
		{SND_PCM_FORMAT_U8, unsigned_8bit},
		{SND_PCM_FORMAT_U16_LE, unsigned_16bit},
		{SND_PCM_FORMAT_S16_LE, signed_16bit},
		{SND_PCM_FORMAT_U24_3LE, unsigned_24bit},
		{SND_PCM_FORMAT_S24_3LE, signed_24bit},
		{SND_PCM_FORMAT_U32_LE, unsigned_32bit},
		{SND_PCM_FORMAT_S32_LE, signed_32bit},
		{SND_PCM_FORMAT_FLOAT_LE, float_32bit},

		{SND_PCM_FORMAT_U16_BE, unsigned_16bit_be},
		{SND_PCM_FORMAT_S16_BE, signed_16bit_be},
		{SND_PCM_FORMAT_U24_3BE, unsigned_24bit_be},
		{SND_PCM_FORMAT_S24_3BE, signed_24bit_be},
		{SND_PCM_FORMAT_U32_BE, unsigned_32bit_be},
		{SND_PCM_FORMAT_S32_BE, signed_32bit_be},
		{SND_PCM_FORMAT_FLOAT_BE, float_32bit_be},
...
core::SpecializedIOFilter<core::RawAudioFrame>(log_,parent, std::string("alsa_input")),
...
bool AlsaInput::is_different_format(const core::pRawAudioFrame& frame)
{
...
core::pFrame AlsaInput::do_special_single_step(core::pRawAudioFrame frame)
{
...
bool AlsaInput::init_alsa(const core::pRawAudioFrame& frame)
{
	if (!handle_) {
