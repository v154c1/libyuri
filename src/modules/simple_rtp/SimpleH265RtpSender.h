...
#ifndef SIMPLEH265RTPSENDER_H_
#define SIMPLEH265RTPSENDER_H_
...
class SimpleH265RtpSender : public core::SpecializedIOFilter<core::CompressedVideoFrame> {
    using base_type = core::SpecializedIOFilter<core::CompressedVideoFrame>;

public:
    IOTHREAD_GENERATOR_DECLARATION
    static core::Parameters configure();
    SimpleH265RtpSender(const log::Log& log_, core::pwThreadBase parent, const core::Parameters& parameters);
    virtual ~SimpleH265RtpSender() noexcept;
